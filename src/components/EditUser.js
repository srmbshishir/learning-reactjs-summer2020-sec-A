...
const EditUser = ({editNewUser, list})=>{
    const {id:eid} = useParams();
    const [user, setUser] = useState({userId: '', id:'', title:''});
    ...
    return(
        ...
        <>
            ...
            <form onSubmit={onsubmit}>
                Name: <input type='text' name='userId' onChange={change} /> <br/>
                ID: <input type='text' name='id' onChange={change} /><br/>
                Dept: <input type='text' name='title' onChange={change} /><br/>
